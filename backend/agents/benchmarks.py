...
A sibling of :mod:`backend.agents.prose` over a different prompt. It reads the
...
from backend.core.schemas import ExtractedBenchmarks, ModelDoc, RejectedValue
from backend.core.store import Store
from backend.extraction.benchmarks import RESPONSE_SCHEMA, SYSTEM_PROMPT, rows
