...
from app.features.agents import about, prose
...
def test_the_about_agent_writes_a_summary_and_narrates(store, monkeypatch):
    ...
    monkeypatch.setattr("app.features.agents.about.search", lambda *a, **kw: [])
    ...
    monkeypatch.setattr("app.features.agents.about.stream_json", stream_json)
...
def test_the_prose_agent_still_grounds_every_value(store, monkeypatch):
    ...
    monkeypatch.setattr("app.features.agents.prose.stream_json", stream_json)
...
def test_the_prose_agent_stamps_the_card_it_was_actually_given(store, monkeypatch):
    ...
    monkeypatch.setattr(
        "app.features.agents.prose.stream_json",
